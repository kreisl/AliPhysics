...
#ifndef ALIREDUCEDANALYSISFLOW_H
#define ALIREDUCEDANALYSISFLOW_H
...
class AliReducedAnalysisFlow : public AliReducedAnalysisTaskSE {

public:
  AliReducedAnalysisFlow();
  AliReducedAnalysisFlow(const Char_t* name, const Char_t* title);
  virtual ~AliReducedAnalysisFlow();
...
protected:
  ...
  ClassDef(AliReducedAnalysisFlow,2);
};
